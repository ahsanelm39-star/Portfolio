...
const Contact = () => {
    return (
        <section id="contact" className="py-14 bg-[#0f0715]">
            <div className="collect flex justify-between items-center gap-10 max-md:flex-col">
                
                <form className="p-8 bg-[#08010e] rounded-xl w-[500px] max-sm:w-1/1">
                    ...
                    <div className="flex max-sm:flex-col gap-4 mb-4 justify-between">
                        <input type="text" className="w-[48%] max-sm:w-1/1 h-[40px] bg-[#0f0715] pl-4 outline-0 caret-amber-50 text-[#cbe1ff]" placeholder="First Nmae"/>
                        <input type="text" className="w-[48%] max-sm:w-1/1 h-[40px] bg-[#0f0715] pl-4 outline-0 caret-amber-50 text-[#cbe1ff]" placeholder="Last Nmae"/>
                    </div>
                    <div className="flex max-sm:flex-col gap-4 mb-4 justify-between">
                        <input type="text" className="w-[48%] max-sm:w-1/1 h-[40px] bg-[#0f0715] pl-4 outline-0 caret-amber-50 text-[#cbe1ff]" placeholder="Email address"/>
                        <input type="text" className="w-[48%] max-sm:w-1/1 h-[40px] bg-[#0f0715] pl-4 outline-0 caret-amber-50 text-[#cbe1ff]" placeholder="Phone Number"/>
                    </div>
